...
if __name__ == '__main__':
    ...
    install_dest = KernelSpecManager().install_kernel_spec(
        os.path.join(os.path.dirname(os.path.abspath(__file__)), 'dataweave'),
        kernel_name='dataweave',
        user=args.user,
    ...
    local_kernel_json_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'dataweave', 'kernel.json')
    ...
    print('Installed dataweave kernel into "%s"' % install_dest)
